...
func (h *transactionHandler) CreateTransaction(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Error to create transaction", http.StatusUnprocessableEntity, "error", nil)
	...
	if err != nil {
		response := helper.APIResponse("Error to create transaction", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
...
func (h *transactionHandler) GetNotification(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Error to process notification", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
